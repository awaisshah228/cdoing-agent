/**
 * OAuth 2.0 (PKCE) for Claude — VS Code Extension
 *
 * Reuses the same endpoints and credential storage as the CLI.
 * In the extension, we use vscode.env.openExternal() to open the browser
 * and an input box to collect the authorization code.
 */
...
// Claude OAuth endpoints (same as CLI / Claude Code)
